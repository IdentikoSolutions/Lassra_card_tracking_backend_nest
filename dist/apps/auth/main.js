...
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
class LocalAuthGuards extends (0, passport_1.AuthGuard)('local') {
}
...
const local_auth_guards_1 = __webpack_require__(/*! ../guards/local-auth.guards */ "./apps/auth/guards/local-auth.guards.ts");
const current_user_decorators_1 = __webpack_require__(/*! ./users/current-user.decorators */ "./apps/auth/src/users/current-user.decorators.ts");
...
const jwt_auth_guard_1 = __webpack_require__(/*! ../guards/jwt-auth.guard */ "./apps/auth/guards/jwt-auth.guard.ts");
...
const logger_1 = __webpack_require__(/*! @app/common/logger */ "./libs/common/src/logger/index.ts");
const jwt_1 = __webpack_require__(/*! @nestjs/jwt */ "@nestjs/jwt");
const Joi = __webpack_require__(/*! joi */ "joi");
const config_1 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
const local_strategy_1 = __webpack_require__(/*! ../strategies/local.strategy */ "./apps/auth/strategies/local.strategy.ts");
const jwt_strategy_1 = __webpack_require__(/*! ../strategies/jwt.strategy */ "./apps/auth/strategies/jwt.strategy.ts");
